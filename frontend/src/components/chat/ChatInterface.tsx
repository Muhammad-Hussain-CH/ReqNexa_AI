    ...
    <div className="h-full flex flex-col">
      ...
      <div className="mt-3">
        <div className="flex items-end gap-2">
          <button className="p-2 rounded border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700"><Paperclip className="w-5 h-5" /></button>
          <textarea
            className="flex-1 px-3 py-2 border rounded resize-none dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100"
