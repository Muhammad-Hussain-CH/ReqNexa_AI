      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 mt-2 hidden group-hover:block bg-white dark:bg-gray-800 border dark:border-gray-700 rounded shadow text-sm">
            <a className="block px-3 py-2 hover:bg-gray-50 dark:hover:bg-gray-700" href="#">Profile</a>
            <a className="block px-3 py-2 hover:bg-gray-50 dark:hover:bg-gray-700" href="#">Settings</a>
            <a className="block px-3 py-2 hover:bg-gray-50 dark:hover:bg-gray-700" href="#">Logout</a>
          </div>
        </div>
      </div>
    </header>
